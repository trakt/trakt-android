...
private val KEY_TRENDING_SHOWS = byteArrayPreferencesKey("key_trending_shows")

internal class TrendingShowsStorage(
    private val dataStore: DataStore<Preferences>,
) : TrendingShowsLocalDataSource {
    ...
    override suspend fun setShows(shows: List<DiscoverItem.ShowItem>) {
        ...
        mutex.withLock {
            ...
            dataStore.edit {
                it[KEY_TRENDING_SHOWS] = ProtoBuf.encodeToByteArray(showsCache)
            }
        }
    }
