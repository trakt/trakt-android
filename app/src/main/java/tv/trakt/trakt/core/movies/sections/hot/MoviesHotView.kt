...
@Composable
internal fun MoviesHotView(
    modifier: Modifier = Modifier,
    viewModel: MoviesHotViewModel = koinViewModel(),
...
@Composable
internal fun MoviesHotContent(
    state: MoviesHotState,
    modifier: Modifier = Modifier,
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = stringResource(R.string.header_most_hot),
