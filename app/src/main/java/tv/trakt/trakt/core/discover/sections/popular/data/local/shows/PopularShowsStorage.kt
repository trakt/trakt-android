...
private val KEY_POPULAR_SHOWS = byteArrayPreferencesKey("key_popular_shows")

internal class PopularShowsStorage(
    private val dataStore: DataStore<Preferences>,
) : PopularShowsLocalDataSource {
    ...
    override suspend fun setShows(shows: List<DiscoverItem.ShowItem>) {
        ...
        mutex.withLock {
            ...
            dataStore.edit {
                it[KEY_POPULAR_SHOWS] = ProtoBuf.encodeToByteArray(showsCache)
            }
        }
    }
