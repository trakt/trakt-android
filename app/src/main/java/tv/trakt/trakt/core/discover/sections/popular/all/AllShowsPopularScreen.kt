...
import tv.trakt.trakt.core.discover.ui.AllShowsListView
...
@Composable
internal fun AllShowsPopularScreen(
    viewModel: AllShowsPopularViewModel,
...
@Composable
private fun AllShowsPopularScreenContent(
...
private fun TitleBar(modifier: Modifier = Modifier) {
    Row(
        ...
        Text(
            text = stringResource(R.string.list_title_popular_shows),
