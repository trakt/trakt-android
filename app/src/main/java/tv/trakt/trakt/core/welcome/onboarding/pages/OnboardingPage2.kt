...
internal fun OnboardingPage2(modifier: Modifier = Modifier) {
    Column(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.text_onboarding_2_title_1),
                style = TraktTheme.typography.heading3,
                color = Color.White,
                textAlign = TextAlign.Start,
            )
            Text(
                text = stringResource(R.string.text_onboarding_2_title_2),
                style = TraktTheme.typography.heading3,
                color = Color.White,
                textAlign = TextAlign.Start,
            )
        ...
        Text(
            text = stringResource(R.string.text_onboarding_2_description),
