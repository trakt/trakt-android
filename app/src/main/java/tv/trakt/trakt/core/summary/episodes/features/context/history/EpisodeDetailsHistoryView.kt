...
package tv.trakt.trakt.core.summary.episodes.features.context.history
...
@Composable
internal fun EpisodeDetailsHistoryView(
...
@Composable
private fun EpisodeDetailsHistoryContent(
    show: Show,
    episode: Episode,
    modifier: Modifier = Modifier,
