package tv.trakt.app.tv.core.profile.di
...
import tv.trakt.app.tv.core.profile.ProfileViewModel
import tv.trakt.app.tv.core.profile.data.remote.ProfileApiClient
import tv.trakt.app.tv.core.profile.data.remote.ProfileRemoteDataSource
import tv.trakt.app.tv.core.profile.sections.favorites.movies.ProfileFavoriteMoviesViewModel
import tv.trakt.app.tv.core.profile.sections.favorites.movies.usecases.GetFavoriteMoviesUseCase
import tv.trakt.app.tv.core.profile.sections.favorites.movies.viewall.ProfileFavoriteMoviesViewAllViewModel
import tv.trakt.app.tv.core.profile.sections.favorites.shows.ProfileFavoriteShowsViewModel
import tv.trakt.app.tv.core.profile.sections.favorites.shows.usecases.GetFavoriteShowsUseCase
import tv.trakt.app.tv.core.profile.sections.favorites.shows.viewall.ProfileFavoriteShowsViewAllViewModel
import tv.trakt.app.tv.core.profile.sections.history.ProfileHistoryViewModel
import tv.trakt.app.tv.core.profile.sections.history.usecases.GetProfileHistoryUseCase
import tv.trakt.app.tv.core.profile.sections.history.usecases.SyncProfileHistoryUseCase
import tv.trakt.app.tv.core.profile.sections.history.viewall.ProfileHistoryViewAllViewModel
import tv.trakt.app.tv.core.profile.usecases.LogoutProfileUseCase
