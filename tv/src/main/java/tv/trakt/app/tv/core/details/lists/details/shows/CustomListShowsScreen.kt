package tv.trakt.app.tv.core.details.lists.details.shows
...
import tv.trakt.app.tv.core.details.lists.details.CustomListDetailsConfig.CUSTOM_LIST_NEXT_PAGE_OFFSET
...
internal fun CustomListShowsScreen(
    viewModel: CustomListShowsViewModel,
    onNavigateToShow: (TraktId) -> Unit,
) {
    val state by viewModel.state.collectAsStateWithLifecycle()

    CustomListShowsContent(
        state = state,
...
@Composable
private fun CustomListShowsContent(
    state: CustomListShowsState,
    listName: String,
