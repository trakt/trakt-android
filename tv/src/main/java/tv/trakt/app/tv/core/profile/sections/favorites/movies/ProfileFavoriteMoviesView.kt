package tv.trakt.app.tv.core.profile.sections.favorites.movies
...
import tv.trakt.app.tv.core.profile.ProfileConfig.PROFILE_FAVORITES_SECTION_LIMIT
...
@Composable
internal fun ProfileFavoriteMoviesView(
    modifier: Modifier = Modifier,
    viewModel: ProfileFavoriteMoviesViewModel = koinViewModel(),
...
@Composable
internal fun ProfileFavoriteMoviesContent(
    state: ProfileFavoriteMoviesState,
    modifier: Modifier = Modifier,
    headerPadding: PaddingValues = PaddingValues(),
    contentPadding: PaddingValues = PaddingValues(),
