...
@Composable
internal fun CustomListMoviesScreen(
    viewModel: CustomListMoviesViewModel,
    onNavigateToMovie: (TraktId) -> Unit,
) {
    val state by viewModel.state.collectAsStateWithLifecycle()

    CustomListMoviesContent(
        state = state,
...
@Composable
private fun CustomListMoviesContent(
    state: CustomListMoviesState,
    listName: String,
