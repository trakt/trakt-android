package tv.trakt.app.tv.core.details.movie.views.header
...
import tv.trakt.app.tv.Config
import tv.trakt.app.tv.R
import tv.trakt.app.tv.core.details.movie.MovieDetailsState.CollectionState
import tv.trakt.app.tv.core.details.movie.MovieDetailsState.StreamingsState
import tv.trakt.app.tv.ui.theme.TraktTheme
import tv.trakt.app.tv.ui.theme.colors.Blue50
import tv.trakt.app.tv.ui.theme.colors.Blue500
import tv.trakt.app.tv.ui.theme.colors.Purple50
import tv.trakt.app.tv.ui.theme.colors.Purple500
...
internal fun MovieActionButtons(
    ...
    Column(
        ...
        WatchNowButton(
            ...
            onClick = {
                if (directLink == null) {
                    uriHandler.openUri("${Config.PLEX_BASE_URL}movie/${streamingState.slug?.value}")
