...
import tv.trakt.trakt.app.core.home.HomeConfig.UP_NEXT_NEXT_PAGE_OFFSET
import tv.trakt.trakt.app.core.home.HomeConfig.UP_NEXT_PAGE_LIMIT
...
private fun loadNextPageIfNeeded(
    ...
    if (size >= UP_NEXT_PAGE_LIMIT && index >= size - UP_NEXT_NEXT_PAGE_OFFSET) {
        onLoadNextPage()
    }
}
