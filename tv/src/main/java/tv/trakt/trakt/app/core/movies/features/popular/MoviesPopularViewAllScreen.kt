...
@Composable
internal fun MoviesPopularScreen(
    viewModel: MoviesPopularViewAllViewModel,
...
@Composable
private fun MoviesPopularContent(
    state: MoviesPopularViewAllState,
    ...
    Box(
        ...
        LazyVerticalGrid(
            ...
            item(span = { GridItemSpan(maxLineSpan) }) {
                Text(
                    text = stringResource(tv.trakt.trakt.resources.R.string.list_title_most_popular),
...
@Preview
@Composable
private fun MoviesPopularContentPreview() {
    TraktTheme {
        MoviesPopularContent(
            state = MoviesPopularViewAllState(
                movies = listOf(
