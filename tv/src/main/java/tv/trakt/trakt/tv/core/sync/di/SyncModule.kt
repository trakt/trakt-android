package tv.trakt.trakt.tv.core.sync.di
...
import tv.trakt.trakt.tv.core.sync.data.local.episodes.EpisodesSyncStorage
import tv.trakt.trakt.tv.core.sync.data.local.movies.MoviesSyncLocalDataSource
import tv.trakt.trakt.tv.core.sync.data.local.movies.MoviesSyncStorage
import tv.trakt.trakt.tv.core.sync.data.local.shows.ShowsSyncLocalDataSource
import tv.trakt.trakt.tv.core.sync.data.local.shows.ShowsSyncStorage
import tv.trakt.trakt.tv.core.sync.data.remote.episodes.EpisodesSyncApiClient
import tv.trakt.trakt.tv.core.sync.data.remote.episodes.EpisodesSyncRemoteDataSource
import tv.trakt.trakt.tv.core.sync.data.remote.movies.MoviesSyncApiClient
import tv.trakt.trakt.tv.core.sync.data.remote.movies.MoviesSyncRemoteDataSource
import tv.trakt.trakt.tv.core.sync.data.remote.shows.ShowsSyncApiClient
